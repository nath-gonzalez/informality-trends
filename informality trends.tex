...
\begin{figure}[!htb]
 ...
 \item Social security contributions
    \begin{itemize}
        ...
        \begin{figure}[!htb]
        \centering
        \caption{Social security contributions status by group}     
        \includegraphics[scale=.3]{latex/figures/Snapshot/Social security contributions.png}
        \label{fig:SScontributions}
        \footnotesize{Source:Household Surveys-SEDLAC.}
        \footnotesize{Note: Latin American simple average for last year available. Some LAC countries don’t have information for 2021, in that cases we use the last available year, Chile 2022, Guatemala 2014; Honduras 2019; Mexico 2018 and Uruguay 2019. The groups are not exclusive}
        \end{figure}
