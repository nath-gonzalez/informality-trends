...
\begin{itemize}
    \item Alternative informality definitions
             \begin{figure}[H]
                \justifying
                \caption{Alternative informality definitions 2023}  
                \centerline{\includegraphics[scale=.3]{latex/figures/Snapshot/Alternative informality definitions_2023.png}}
                \label{fig:info_definitions}
                \footnotesize{Source: Household Surveys-SEDLAC and ILO.}
                \footnotesize{Note: Each bar is a simple average of country level data in 2023. Countries included in the sample: Argentina, Bolivia, Brazil, Chile, Colombia, Costa Rica, Dominican Republic, Ecuador, El Salvador, Guatemala, Honduras, Mexico, Panama, Peru, Paraguay and Uruguay. For countries without information for 2023 in SEDLAC we use the last available year: Chile 2022;  Honduras 2019 and Mexico 2024. Note: Productive definition includes these groups of workers: salaried worker in small private firm, self-employed with less than completed tertiary education, unpaid workers and employer in small private firms.}
             \end{figure}
        ...
        \item Structure of Employment
            ...
            \begin{figure}[H]
                ...
                \footnotesize{Source: Household Surveys-SEDLAC.}
                \footnotesize{Note: Each bar is a simple average of country level data in 2023. Countries included in the sample: Argentina, Bolivia, Brazil, Chile, Colombia, Costa Rica, Dominican Republic, Ecuador, El Salvador, Guatemala, Honduras, Mexico, Panama, Peru, Paraguay and Uruguay. For countries without information for 2023 in SEDLAC we use the last available year: Chile 2022;  Honduras 2019 and Mexico 2024. The "non-salaried" category corresponds to unpaid workers such as family or cooperative workers.}
            \end{figure}
            ...
            \begin{figure}[H]
                ...
                \justifying
                \footnotesize{Source: Household Surveys-SEDLAC.}
                \footnotesize{Note: Each bar is a simple average of country level data in 2023. Countries included in the sample: Argentina, Bolivia, Brazil, Chile, Colombia, Costa Rica, Dominican Republic, Ecuador, El Salvador, Guatemala, Honduras, Mexico, Panama, Peru, Paraguay and Uruguay. For countries without information for 2023 in SEDLAC we use the last available year: Chile 2022;  Honduras 2019 and Mexico 2024. Argentina only has information on contributions to social security for salaried workers, we are assuming all self-employed workers do not contribute.}
        ...
        \item Structure of Employment II - Sector and Contribution to SS
            ...
            \begin{figure}[H]
                ...
                \label{fig:sector}}
               \footnotesize{Source: Household Surveys-SEDLAC.}
                \footnotesize{Note: Each bar is a simple average of country level data in 2023. Countries included in the sample: Argentina, Bolivia, Brazil, Chile, Colombia, Costa Rica, Dominican Republic, Ecuador, El Salvador, Guatemala, Honduras, Mexico, Panama, Peru, Paraguay and Uruguay. For countries without information for 2023 in SEDLAC we use the last available year: Chile 2022;  Honduras 2019 and Mexico 2024. Argentina is excluded from this figure because the household survey is urban.}
            \end{figure}
        ...
        \item Employment by Firm Size
            \begin{figure}[H]
                    ...
                    \label{fig:firmsize}}
                    \footnotesize{Source: Household Surveys-SEDLAC.}
                    \footnotesize{Note: Each bar is a simple average of country level data in 2023. Countries included in the sample: Argentina, Bolivia, Brazil, Chile, Colombia, Costa Rica, Dominican Republic, Ecuador, El Salvador, Guatemala, Honduras, Mexico, Panama, Peru, Paraguay and Uruguay. For countries without information for 2023 in SEDLAC we use the last available year: Chile 2022;  Honduras 2019 and Mexico 2024. We exclude Argentina, Dominican Republic and Guatemala, because of missing information in firm size variable.}
            \end{figure}
...
\end{figure}
            ...
            \begin{figure}[H]
                    \justifying
                    \caption{Structure of private employment by firm size 2023*}     \centerline{\includegraphics[scale=.3]{latex/figures/Snapshot/Employment and SS by firmsize_2.png}}
        ...
        \item Social security contributions
                    ...
                    \footnotesize{Source: Household Surveys-SEDLAC.}
                    \footnotesize{Note: Each bar is a simple average of country level data in 2023. Countries included in the sample: Argentina, Bolivia, Brazil, Chile, Colombia, Costa Rica, Dominican Republic, Ecuador, El Salvador, Guatemala, Honduras, Mexico, Panama, Peru, Paraguay and Uruguay. For countries without information for 2023 in SEDLAC we use the last available year: Chile 2022;  Honduras 2019 and Mexico 2024.
        ...
        \item Life cycle- self employment and salaried informal
             \begin{figure}[H]
                        ...
                        \label{fig:age_pro}}
                        \footnotesize{Source: Household Surveys-SEDLAC.}
                        \footnotesize{Note: Each line is a simple average of country level data. Country level data is computed weighting by total workers. Countries included in the sample: Argentina, Bolivia, Brazil, Chile, Colombia, Costa Rica, Dominican Republic, Ecuador, El Salvador, Guatemala, Honduras, Mexico, Panama, Peru, Paraguay and Uruguay. Data corresponds to 2023. For countries without information for 2023 in SEDLAC we use the last available year: Chile 2022;  Honduras 2019 and Mexico 2024}
             \end{figure}
\end{itemize}
...
\begin{figure}[H]
    ...
    \footnotesize{Source: Household Surveys-SEDLAC.}
    \footnotesize{Note: Each bar is a weighted average of each country, weighting by total workers in 2023. For countries without information for 2023 in SEDLAC we use the last available year: Chile 2022;  Honduras 2019 and Mexico 2024.}
...
\begin{figure}[H]
    \justifying
     \caption{Snapshot of LAC’s household employment condition for 2005-2023}     
     \centerline{\includegraphics[scale=.3]{latex/figures/Household/snapshot_household_2005-2023_LAC.png}
    \label{fig:HouseholdLAC}}
    \footnotesize{Source: Household Surveys-SEDLAC.}
    \footnotesize{Note: Each bar is a weighted average of each country, weighting by total workers in 2005 and 2023. For countries without information for 2023 in SEDLAC we use the last available year: Chile 2022; Mexico 2024 and Honduras 2019.}
     \footnotesize{Note: The figure reports the household contribution status to social security of households with at least one member works. All contribute: corresponds to the percentage of households where all workers contribute to SS. Some contribute: corresponds to the percentage of households where some workers contribute to SS but not all. No one contributes: corresponds to the percentage of households where no workers contributes to SS.}
\end{figure}
...
\begin{figure}[!htb]
    \centering
    \caption{Snapshot of LAC’s countries household employment condition for 2005-2023}     
    \centerline{\includegraphics[scale=.45]{latex/figures/Household/snapshot_household_2005-2023.png}
...
\begin{figure}[H]
    ...
    \footnotesize{Source: Household Surveys-SEDLAC.}
    \footnotesize{Note: Each bar is a weighted average of each country, weighting by total workers in 2005 and 2023. For countries without information for 2023 in SEDLAC we use the last available year: Chile 2022; Mexico 2024 and Honduras 2019. Please note that Dominican Republic is excluded because survey change in 2017.}
\end{figure}
...
\begin{figure}[H]
    ...
    \footnotesize{Source: Household Surveys-SEDLAC.}
    \footnotesize{Note: Each bar is a weighted average of each country, weighting by total workers in small firms in 2005 and 2023.For countries without information for 2023 in SEDLAC we use the last available year: Chile 2022; Mexico 2024 and Honduras 2019. Please note that Dominican Republic is excluded because survey change in 2017.}
\end{figure}


\begin{figure}[H]
        \justifying
        \caption{Microeconometric decomposition of evolution of workers who does not contribute to ss 2005-2023}     
       \centerline{\includegraphics[scale=.3]{latex/figures/Snapshot/Oaxaca decomposition level.png}
        \label{fig:Oaxaca_level}}
        \footnotesize{Source: Household Surveys-SEDLAC.}
        \footnotesize{Note: Each bar is the actual change in Social security contributions corresponds to the level of coefficients and the level of the endowment effects.  Data corresponds to 2023. For countries without information for 2023 in SEDLAC we use the last available year: Chile 2022; Mexico 2024 and Honduras 2019.}
 \end{figure}
...
\begin{figure}[H]
                ...
                \end{subfigure}
                 ...
                 \footnotesize{Source: Household Surveys-SEDLAC.}
                \footnotesize{Note: Each bar is a simple average of country level data in 2023. Countries included in the samp
                le: Argentina, Bolivia, Brazil, Chile, Colombia, Costa Rica, Dominican Republic, Ecuador, El Salvador, Guatemala, Honduras, Mexico, Panama, Peru, Paraguay and Uruguay. For countries without information for 2023 in SEDLAC we use the last available year: Chile 2022; Mexico 2024 and Honduras 2019. Panel a: bar one and two are defined as percentage of the population. Also, "Participation rate" and "Female participation" are define as part of the labor force defined for people between 18 and 65 years old. Panel b: "LF tertiary education" corresponds to people in the workforce who have completed tertiary education.}
