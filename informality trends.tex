...
\begin{figure}[H]
    \centering
    \caption{Structure of private employment by firm size}
    \subfloat[\centering2005*]{{\includegraphics[width=5.5cm]{latex/figures/Snapshot/Employment and SS by firmsize_1.png}}}%
    \qquad
    \subfloat[\centering2022*]{{\includegraphics[width=5.5cm]{latex/figures/Snapshot/Employment and SS by firmsize_2.png}}}%
    \label{fig:example}%
\end{figure}
